...
exports.bee = async function (t, def, opts) {
  if (!HyperDB.isDefinition(def)) return exports.bee(t, require(`../fixtures/generated/${(def && def.fixture) || 1}/hyperdb`), def)

  const db = HyperDB.bee(new Hypercore(await tmp(t)), def, opts)
  const engine = db.engine
