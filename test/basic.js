...
const { rocks, bee } = require('./helpers')

run(rocks)
run(bee)

function run (create) {
  const prefix = create === rocks ? 'rocks - ' : 'bee - '

  test(prefix + 'basic full example', async function (t) {
    const db = await create(t, definition)
  ...
  test(prefix + 'delete record', async function (t) {
    const db = await bee(t, definition)
  ...
  test(prefix + 'generated full example', async function (t) {
  ...
  test(prefix + 'generated delete record', async function (t) {
    const db = await create(t)
  ...
  test(prefix + 'delete from memview', async function (t) {
    const db = await create(t)
  ...
  test(prefix + 'watch', async function (t) {
    t.plan(4)
  ...
  test(prefix + 'stats', async function (t) {
    const db = await create(t, { fixture: 2 })
